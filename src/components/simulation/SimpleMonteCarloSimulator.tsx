                  ...
                  <div className="space-y-3 text-sm">
                    <div className="p-3 bg-muted/50 rounded-lg space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">
                        ​• <strong>Range A:</strong> First 11% of your range. 50% total probability weight, probability increases within this zone.  Values closer to the top of this band are more likely.
                      </p>
                      <p className="text-xs text-muted-foreground">
                        • <strong>Range B:</strong> From 11% to 44% of your range. 40% total probability weight, short flat plateau early,  then probability gradually decreases toward the upper end.
                      </p>
                      <p className="text-xs text-muted-foreground">
                        • <strong>Range C:</strong>  From 44% to 100% of your range. 10% total probability weight. This is the high-end zone. Values closer to your maximum are increasingly rare
                      </p>
